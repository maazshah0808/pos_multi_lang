                        ...
                        <div class="col-span-12 sm:col-span-6 xl:col-span-3 intro-y">
                            <div class="report-box zoom-in">
                                <div class="box p-5">
                                    ...
                                    <div class="text-base text-slate-500 mt-1">Today Return</div>
                                </div>
                            </div>
                        </div>
                        <div class="col-span-12 sm:col-span-6 xl:col-span-3 intro-y">
                                ...
                                <div class="box p-5">
                                    <div class="flex">
                                        {{-- <i data-lucide="user" class="report-box__icon text-success"></i> --}}
                                         <img alt="Logo FBR" src="{{ asset('build/assets/images/FBR-LOGO.PNG') }}">
                                        
                                    </div>
                                    <div class="text-3xl font-medium leading-8 mt-6">152.040</div>
                                    <div class="text-base text-slate-500 mt-1">Sales Tax</div>
                                </div>
                            </div>
                        </div>
                    </div>
